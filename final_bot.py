...
st.write("النسخة المتكاملة: تدعم القائمة الكاملة لأسهم البورصة المصرية، الأسهم الأمريكية، والأسواق الإماراتية بمعايير حماية صارمة.")
...
# تحديد القواميس والعملة بناءً على السوق المختار مع القوائم الكاملة
if "المصرية" in market_choice:
    ...
    TICKER_SECTOR = {
        ...
        "HELI.CA": "عقاري", "AMOC.CA": "طاقة", "ORWE.CA": "تصنيع", "ISPH.CA": "رعاية صحية",
        "CIEB.CA": "بنوك", "ADIB.CA": "بنوك", "CIRA.CA": "خدمات تعليمية", "EMFD.CA": "عقاري",
        "DICE.CA": "تصنيع", "SPMD.CA": "رعاية صحية", "AUTO.CA": "تصنيع", "BTFH.CA": "مالي غير مصرفي",
        "PRDC.CA": "مالي غير مصرفي", "INFI.CA": "استهلاكي", "ELSH.CA": "عقاري"
    }
    ...
    TICKER_SECTOR = {
        ...
        "INTC": "تكنولوجيا", "CSCO": "تكنولوجيا", "ADBE": "تكنولوجيا", "CRM": "تكنولوجيا",
        "PFE": "رعاية صحية", "ABBV": "رعاية صحية", "TMO": "رعاية صحية", "COST": "استهلاكي",
        "PEP": "استهلاكي", "KO": "استهلاكي", "DIS": "خدمات إعلامية", "BAC": "بنوك",
        "QCOM": "تكنولوجيا", "IBM": "تكنولوجيا", "TXN": "تكنولوجيا", "AMAT": "تكنولوجيا",
        "ORCL": "تكنولوجيا", "PYPL": "تكنولوجيا", "NKE": "استهلاكي", "SBUX": "استهلاكي"
    }
else:  # الإماراتية
    CURRENCY = "د.إ"
    ...
    ALL_STOCKS = {
        ...
        "Dubai Financial Market (DFM)": "DFM.DU",
        "Commercial Bank of Dubai (DFM)": "CBD.DU",
        "Salama Islamic Insurance (DFM)": "SALAMA.DU",
        "Union Properties (DFM)": "UPP.DU",
        "Amanat Holdings (DFM)": "AMANAT.DU",
        ...
        "Alpha Dhabi Holding (ADX)": "ALPHADHABI.AD",
        "Fertiglobe (ADX)": "FERTIGLOBE.AD",
        "PureHealth Holding (ADX)": "PUREHEALTH.AD",
        "ADNOC Drilling (ADX)": "ADNOCDRILL.AD",
        "NMDC Group (ADX)": "NMDC.AD"
    }
    TICKER_SECTOR = {
        "EMAAR.DU": "عقاري", "ENBD.DU": "بنوك", "DIB.DU": "بنوك", "EMAARDEV.DU": "عقاري",
        "ARMX.DU": "خدمات لوجستية", "DIC.DU": "استثمار", "DFM.DU": "مالي غير مصرفي",
        "CBD.DU": "بنوك", "SALAMA.DU": "تأمين", "UPP.DU": "عقاري", "AMANAT.DU": "استثمار متنوع",
        "FAB.AD": "بنوك", "IHC.AD": "استثمار متنوع", "MULTIPLY.AD": "استثمار متنوع",
        "ALDAR.AD": "عقاري", "ADCB.AD": "بنوك", "ADNOCDIST.AD": "طاقة", "TAQA.AD": "طاقة",
        "ALPHADHABI.AD": "استثمار متنوع", "FERTIGLOBE.AD": "تصنيع", "PUREHEALTH.AD": "رعاية صحية",
        "ADNOCDRILL.AD": "طاقة", "NMDC.AD": "مقاولات وبنية تحتية"
    }
...
with tab2:
    ...
    with fcol1:
        ...
        selected_sectors_scan = st.multiselect(
            "🏢 فلتر القطاع (اتركه فارغاً لعرض كل القطاعات)",
